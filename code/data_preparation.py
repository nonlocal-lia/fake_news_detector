...
def get_network_metrics(model, X_train, y_train, X_test, y_test, batch_size=32, rare_cat=False):

    """
    Gets accuracy, and weighted F1 scores of a Keras classification model for both training and test data
    If rare_cat = True, also determines the rarest category in the data and calculates the model's precision, recall, and F1
